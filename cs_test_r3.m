...
for sub=1:25
   ...
   features_sogg_60cs3(1:size(q_q2,1),:)=q_q2(1:size(q_q2,1),:);
    ...
    accuracy_40_60cs3(sub,1)=sum(predizioni3==l2_2)/length(l2_2)*100;
...
FN2=sum((predizioni3~=positive_class) & (l_l2==positive_class));
    ...
    accuracy_40_60cs1(sub,2)=sum(predizioni4==l2_2)/length(l2_2)*100;
    accuracy_40_60cs2(sub,2)=sum(predizioni5==l2_2)/length(l2_2)*100;
    accuracy_40_60cs3(sub,2)=sum(predizioni6==l2_2)/length(l2_2)*100;
         positive_class = 1;
...
FN2=sum((predizioni6~=positive_class) & (l_l2==positive_class));
    ...
    accuracy_40_60cs1(sub,3)=sum(predizioni7==l2_2)/length(l2_2)*100;
    accuracy_40_60cs2(sub,3)=sum(predizioni8==l2_2)/length(l2_2)*100;
    accuracy_40_60cs3(sub,3)=sum(predizioni9==l2_2)/length(l2_2)*100;
             positive_class = 1;
