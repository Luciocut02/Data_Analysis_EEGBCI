...
for sub=1:25
    ...
    accuracy_80_20cs1(sub,1)=sum(predizioni1==l_l2)/length(l_l2)*100;
    accuracy_80_20cs2(sub,1)=sum(predizioni2==l_l2)/length(l_l2)*100;
    accuracy_80_20cs3(sub,1)=sum(predizioni3==l_l2)/length(l_l2)*100;
...
FN2=sum((predizioni3~=positive_class) & (l_l2==positive_class));
    ...
    accuracy_80_20cs1(sub,2)=sum(predizioni4==l_l2)/length(l_l2)*100;
    accuracy_80_20cs2(sub,2)=sum(predizioni5==l_l2)/length(l_l2)*100;
    accuracy_80_20cs3(sub,2)=sum(predizioni6==l_l2)/length(l_l2)*100;
         positive_class = 1;
...
FN2=sum((predizioni6~=positive_class) & (l_l2==positive_class));
    ...
    accuracy_80_20cs1(sub,3)=sum(predizioni7==l_l2)/length(l_l2)*100;
    accuracy_80_20cs2(sub,3)=sum(predizioni8==l_l2)/length(l_l2)*100;
    accuracy_80_20cs3(sub,3)=sum(predizioni9==l_l2)/length(l_l2)*100;
             positive_class = 1;
