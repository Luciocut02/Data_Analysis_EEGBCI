...
%     precision1_60_40pc_1_2(s,se,1)=(TP)/(TP+FP);
%     recall1_60_40pc_1_2(s,se,1)=(TP)/(TP+FN);
%    positive_class = 2;
...
%     precision2_60_40pc_1_2(s,se,1)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_1_2(s,se,1)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcnet(x_x2,labels_tr,'OptimizeHyperparameters','auto');
%  time_train1_2(s,se,2)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict1_2(s,se,2)=toc;
%  accuracy_60_40_1(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_1_2(s,se,2)=(TP)/(TP+FP);
%     recall1_60_40pc_1_2(s,se,2)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_1_2(s,se,2)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_1_2(s,se,2)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcensemble(x_x,labels_tr,'OptimizeHyperparameters','auto');
%  time_train1_2(s,se,3)=toc;
%  tic;
%  predizioni=predict(mod,y_y);
%  time_predict1_2(s,se,3)=toc;
%  accuracy_60_40_1(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_1_2(s,se,3)=(TP)/(TP+FP);
%     recall1_60_40pc_1_2(s,se,3)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_1_2(s,se,3)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_1_2(s,se,3)=(TP2)/(TP2+FN2);
%     end
% end
% 
% 
...
%  tic;
%  mod=fitcsvm(x_x2,labels_tr,'KernelFunction','polynomial','OptimizeHyperparameters','auto');
%  time_train2_2(s,se,1)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict2_2(s,se,1)=toc;
%  accuracy_60_40_2(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_2_2(s,se,1)=(TP)/(TP+FP);
%     recall1_60_40pc_2_2(s,se,1)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_2_2(s,se,1)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_2_2(s,se,1)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcnet(x_x2,labels_tr,'OptimizeHyperparameters','auto');
%  time_train2_2(s,se,2)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict2_2(s,se,2)=toc;
%  accuracy_60_40_2(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_2_2(s,se,2)=(TP)/(TP+FP);
%     recall1_60_40pc_2_2(s,se,2)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_2_2(s,se,2)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_2_2(s,se,2)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcensemble(x_x,labels_tr,'OptimizeHyperparameters','auto');
%  time_train2_2(s,se,3)=toc;
%  tic;
%  predizioni=predict(mod,y_y);
%  time_predict2_2(s,se,3)=toc;
%  accuracy_60_40_2(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_2_2(s,se,3)=(TP)/(TP+FP);
%     recall1_60_40pc_2_2(s,se,3)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_2_2(s,se,3)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_2_2(s,se,3)=(TP2)/(TP2+FN2);
%     end
% end
% 
% for s=1:25
...
%  tic;
%  mod=fitcsvm(x_x2,labels_tr,'KernelFunction','polynomial','OptimizeHyperparameters','auto');
%  time_train3_2(s,se,1)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict3_2(s,se,1)=toc;
%  accuracy_60_40_3_2(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_3_2(s,se,1)=(TP)/(TP+FP);
%     recall1_60_40pc_3_2(s,se,1)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_3_2(s,se,1)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_3_2(s,se,1)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcnet(x_x2,labels_tr,'OptimizeHyperparameters','auto');
%  time_train3_2(s,se,2)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict3_2(s,se,2)=toc;
%  accuracy_60_40_3_2(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_3_2(s,se,2)=(TP)/(TP+FP);
%     recall1_60_40pc_3_2(s,se,2)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_3_2(s,se,2)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_3_2(s,se,2)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcensemble(x_x,labels_tr,'OptimizeHyperparameters','auto');
%  time_train3_2(s,se,3)=toc;
%  tic;
%  predizioni=predict(mod,y_y);
%  time_predict3_2(s,se,3)=toc;
%  accuracy_60_40_3_2(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_60_40pc_3_2(s,se,3)=(TP)/(TP+FP);
%     recall1_60_40pc_3_2(s,se,3)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_60_40pc_3_2(s,se,3)=(TP2)/(TP2+FP2);
%     recall2_60_40pc_3_2(s,se,3)=(TP2)/(TP2+FN2);
%     end
% end
for s=1:25
    for se=1:5
