save('results1wsr1_2.mat','accuracy_80_20def2_1','time_matrix_train_80_20def2_1','time_matrix_predict_80_20def2_1');
save('results2wsr1_2.mat','accuracy_60_40def2_1','time_matrix_train_60_40def2_1','time_matrix_predict_60_40def2_1');
save('results3wsr1_2.mat','accuracy_40_60def2_1','time_matrix_train_40_60def2_1','time_matrix_predict_40_60def2_1');
save('results4wsr1_2.mat','accuracy_20_80def2_1','time_matrix_train_20_80def2_1','time_matrix_predict_20_80def2_1');
save('results1wsr1_2_2.mat',' precision1_80_20def2_1',' precision2_80_20def2_1','recall1_80_20def2_1',' recall2_80_20def2_1');
save('results2wsr1_2_2.mat',' precision1_60_40def2_1',' precision2_60_40def2_1','recall1_60_40def2_1',' recall2_60_40def2_1');
save('results3wsr1_2_2.mat',' precision1_40_60def2_1',' precision2_40_60def2_1','recall1_40_60def2_1',' recall2_40_60def2_1');
save('results4wsr1_2_2.mat',' precision1_20_80def2_1',' precision2_20_80def2_1','recall1_20_80def2_1',' recall2_20_80def2_1');
for sub=1:25
        for cl=1:3
        [val,idx]=sort(accuracy_80_20_1(sub,1:5,cl),'descend');
        accuracy_80_20def(sub,1:5,cl)=val;
        accuracy_80_20def(sub,6:10,cl)=idx;
        [val2,idx2]=sort(accuracy_60_40_1(sub,1:5,cl),'descend');
        accuracy_60_40def(sub,1:5,cl)=val2;
        accuracy_60_40def(sub,6:10,cl)=idx2;
        [val3,idx3]=sort(accuracy_40_60_1(sub,1:5,cl),'descend');
        accuracy_40_60def(sub,1:5,cl)=val3;
        accuracy_40_60def(sub,6:10,cl)=idx3;
        [val4,idx4]=sort(accuracy_20_80_1(sub,1:5,cl),'descend');
...
for sub=1:25
    for cl=1:3
        time_matrix_train_80_20def2_1(sub,1:2,cl)=time_train1(sub,accuracy_80_20def2_1(sub,3:4,cl),cl);
         time_matrix_train_60_40def2_1(sub,1:2,cl)=time_train2(sub,accuracy_60_40def2_1(sub,3:4,cl),cl);
          time_matrix_train_40_60def2_1(sub,1:2,cl)=time_train3(sub,accuracy_40_60def2_1(sub,3:4,cl),cl);
           time_matrix_train_20_80def2_1(sub,1:2,cl)=time_train4(sub,accuracy_20_80def2_1(sub,3:4,cl),cl);
           time_matrix_predict_80_20def2_1(sub,1:2,cl)=time_predict1(sub,accuracy_80_20def2_1(sub,3:4,cl),cl);
         time_matrix_predict_60_40def2_1(sub,1:2,cl)=time_predict1_1(sub,accuracy_60_40def2_1(sub,3:4,cl),cl);
          time_matrix_predict_40_60def2_1(sub,1:2,cl)=time_predict1_2(sub,accuracy_40_60def2_1(sub,3:4,cl),cl);
           time_matrix_predict_20_80def2_1(sub,1:2,cl)=time_predict1_3(sub,accuracy_20_80def2_1(sub,3:4,cl),cl);
    end
end

for sub=1:25
    for cl=1:3
        precision1_80_20def2_1(sub,1:2,cl)=precision1_80_20pc_1(sub,accuracy_80_20def2_1(sub,3:4,cl),cl);
        precision2_80_20def2_1(sub,1:2,cl)=precision2_80_20pc_1(sub,accuracy_80_20def2_1(sub,3:4,cl),cl);
        recall1_80_20def2_1(sub,1:2,cl)=recall1_80_20pc_1(sub,accuracy_80_20def2_1(sub,3:4,cl),cl);
        recall2_80_20def2_1(sub,1:2,cl)=recall2_80_20pc_1(sub,accuracy_80_20def2_1(sub,3:4,cl),cl);

        precision1_60_40def2_1(sub,1:2,cl)=precision1_60_40pc_1(sub,accuracy_60_40def2_1(sub,3:4,cl),cl);
        precision2_60_40def2_1(sub,1:2,cl)=precision2_60_40pc_1(sub,accuracy_60_40def2_1(sub,3:4,cl),cl);
        recall1_60_40def2_1(sub,1:2,cl)=recall1_60_40pc_1(sub,accuracy_60_40def2_1(sub,3:4,cl),cl);
        recall2_60_40def2_1(sub,1:2,cl)=recall2_60_40pc_1(sub,accuracy_60_40def2_1(sub,3:4,cl),cl);

        precision1_40_60def2_1(sub,1:2,cl)=precision1_40_60pc_1(sub,accuracy_40_60def2_1(sub,3:4,cl),cl);
        precision2_40_60def2_1(sub,1:2,cl)=precision2_40_60pc_1(sub,accuracy_40_60def2_1(sub,3:4,cl),cl);
        recall1_40_60def2_1(sub,1:2,cl)=recall1_40_60pc_1(sub,accuracy_40_60def2_1(sub,3:4,cl),cl);
        recall2_40_60def2_1(sub,1:2,cl)=recall2_40_60pc_1(sub,accuracy_40_60def2_1(sub,3:4,cl),cl);

        precision1_20_80def2_1(sub,1:2,cl)=precision1_20_80pc_1(sub,accuracy_20_80def2_1(sub,3:4,cl),cl);
        precision2_20_80def2_1(sub,1:2,cl)=precision2_20_80pc_1(sub,accuracy_20_80def2_1(sub,3:4,cl),cl);
        recall1_20_80def2_1(sub,1:2,cl)=recall1_20_80pc_1(sub,accuracy_20_80def2_1(sub,3:4,cl),cl);
        recall2_20_80def2_1(sub,1:2,cl)=recall2_20_80pc_1(sub,accuracy_20_80def2_1(sub,3:4,cl),cl);
    end
end

%Da qui inizia rappresentazione definitiva con le sessioni più performanti
...
for sub=1:25
    for ses=1:5
        ...
        w_w=eval(w);
        s_s=eval(s);
        time_extraxtion_feature_train_2(sub,ses)=s_s*size(d_d,1)/(size(d_d,1)+size(w_w,1));
...
for sub=1:25
    for ses=1:5
        ...
        w_w=eval(w);
        s_s=eval(s);
        time_extraxtion_feature_train_3(sub,ses)=s_s*size(d_d,1)/(size(d_d,1)+size(w_w,1));
...
for sub=1:25
    ...
    time_traindef(sub,1:2,cl)=time_extraction_feature_train(sub,accuracy_80_20def2_1(sub,3:4,cl));
    time_testdef(sub,1:2,cl)=time_extraction_features_test(sub,accuracy_80_20def2_1(sub,3:4,cl));


    time_traindef2(sub,1:2,cl)=time_extraxtion_feature_train_2(sub,accuracy_60_40def2_1(sub,3:4,cl));
    time_testdef2(sub,1:2,cl)=time_extraction_features_test_2(sub,accuracy_60_40def2_1(sub,3:4,cl));


    time_traindef3(sub,1:2,cl)=time_extraxtion_feature_train_3(sub,accuracy_40_60def2_1(sub,3:4,cl));
    time_testdef3(sub,1:2,cl)=time_extraction_features_test_3(sub,accuracy_40_60def2_1(sub,3:4,cl));


    time_traindef4(sub,1:2,cl)=time_extraction_feature_train_4(sub,accuracy_20_80def2_1(sub,3:4,cl));
