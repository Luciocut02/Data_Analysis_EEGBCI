...
labels_ts=transpose(labels_ts);
 ...
 close all
 time_train1(s,se,1)=toc;
 tic;
 predizioni=predict(mod,y_y2);
 time_predict1(s,se,1)=toc;
 tic;
 predizioni2=predict(mod,z_z2);
 time_predict2(s,se,1)=toc;
 tic;
 predizioni3=predict(mod,p_p2);
 time_predict3(s,se,1)=toc;
 accuracy_80_20_1(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
 accuracy_80_20_2(s,se,1)=sum(predizioni2==labels_ts)/length(labels_ts)*100;
 accuracy_80_20_3(s,se,1)=sum(predizioni3==labels_ts)/length(labels_ts)*100;
 positive_class = 1;
...
FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_1(s,se,1)=(TP)/(TP+FP);
    recall1_80_20pc_1(s,se,1)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_1(s,se,1)=(TP2)/(TP2+FP2);
    recall2_80_20pc_1(s,se,1)=(TP2)/(TP2+FN2);
 positive_class = 1;
...
FN=sum((predizioni2~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_2(s,se,1)=(TP)/(TP+FP);
    recall1_80_20pc_2(s,se,1)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni2~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_3(s,se,1)=(TP2)/(TP2+FP2);
    recall2_80_20pc_3(s,se,1)=(TP2)/(TP2+FN2);
    positive_class = 1;
...
FN=sum((predizioni3~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_3(s,se,1)=(TP)/(TP+FP);
    recall1_80_20pc_3(s,se,1)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni3~=positive_class) & (labels_ts==positive_class));
 ...
 close all
 time_train1(s,se,2)=toc;
 tic;
 predizioni4=predict(mod2,y_y2);
 time_predict1(s,se,2)=toc;
 tic;
 predizioni5=predict(mod2,z_z2);
 time_predict2(s,se,2)=toc;
 tic;
 predizioni6=predict(mod2,p_p2);
 time_predict3(s,se,2)=toc;

 accuracy_80_20_1(s,se,2)=sum(predizioni4==labels_ts)/length(labels_ts)*100;
 accuracy_80_20_2(s,se,2)=sum(predizioni5==labels_ts)/length(labels_ts)*100;
 accuracy_80_20_3(s,se,2)=sum(predizioni6==labels_ts)/length(labels_ts)*100;
 positive_class = 1;
...
FN=sum((predizioni4~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_1(s,se,2)=(TP)/(TP+FP);
    recall1_80_20pc_1(s,se,2)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni4~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_1(s,se,2)=(TP2)/(TP2+FP2);
    recall2_80_20pc_1(s,se,2)=(TP2)/(TP2+FN2);
    positive_class = 1;
...
FN=sum((predizioni5~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_2(s,se,2)=(TP)/(TP+FP);
    recall1_80_20pc_2(s,se,2)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni5~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_2(s,se,2)=(TP2)/(TP2+FP2);
    recall2_80_20pc_2(s,se,2)=(TP2)/(TP2+FN2);
    positive_class = 1;
...
FN=sum((predizioni6~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_3(s,se,2)=(TP)/(TP+FP);
    recall1_80_20pc_3(s,se,2)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni6~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_3(s,se,2)=(TP2)/(TP2+FP2);
    recall2_80_20pc_3(s,se,2)=(TP2)/(TP2+FN2);

 tic;
 mod3=fitcensemble(x_x,labels_tr,'OptimizeHyperparameters','auto');
 close all
 time_train1(s,se,3)=toc;
 tic;
 predizioni7=predict(mod3,y_y);
 time_predict1(s,se,3)=toc;
 tic;
 predizioni8=predict(mod3,z_z);
 time_predict2(s,se,3)=toc;
 tic;
 predizioni9=predict(mod3,p_p);
 time_predict3(s,se,3)=toc;
 accuracy_80_20_1(s,se,3)=sum(predizioni7==labels_ts)/length(labels_ts)*100;
 accuracy_80_20_2(s,se,3)=sum(predizioni8==labels_ts)/length(labels_ts)*100;
 accuracy_80_20_3(s,se,3)=sum(predizioni9==labels_ts)/length(labels_ts)*100;
...
FN=sum((predizioni7~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_1(s,se,3)=(TP)/(TP+FP);
    recall1_80_20pc_1(s,se,3)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni7~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_1(s,se,3)=(TP2)/(TP2+FP2);
    recall2_80_20pc_1(s,se,3)=(TP2)/(TP2+FN2);
...
FN=sum((predizioni8~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_2(s,se,3)=(TP)/(TP+FP);
    recall1_80_20pc_2(s,se,3)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni8~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_2(s,se,3)=(TP2)/(TP2+FP2);
    recall2_80_20pc_2(s,se,3)=(TP2)/(TP2+FN2);
...
FN=sum((predizioni9~=positive_class) & (labels_ts==positive_class));
    precision1_80_20pc_3(s,se,3)=(TP)/(TP+FP);
    recall1_80_20pc_3(s,se,3)=(TP)/(TP+FN);
   positive_class = 2;
...
FN2=sum((predizioni9~=positive_class) & (labels_ts==positive_class));
    precision2_80_20pc_3(s,se,3)=(TP2)/(TP2+FP2);
    recall2_80_20pc_3(s,se,3)=(TP2)/(TP2+FN2);
    end
end
save('metrics_ws_80_20r.mat','accuracy_80_20_1','accuracy_80_20_2','accuracy_80_20_3')
save('metrics2_ws_80_20r.mat','precision1_80_20pc_1','precision1_80_20pc_2','precision1_80_20pc_3','precision2_80_20pc_1','precision2_80_20pc_2','precision2_80_20pc_3','recall1_80_20pc_1','recall2_80_20pc_1','recall1_80_20pc_2','recall2_80_20pc_2','recall1_80_20pc_3','recall2_80_20pc_3')
save('time_80_20r.mat','time_train1','time_predict1','time_predict2','time_predict3')
...
%  predizioni=predict(mod,y_y2);
%  time_predict2(s,se,1)=toc;
%  accuracy_80_20_2(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
...
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_80_20pc_2(s,se,1)=(TP2)/(TP2+FP2);
%     recall2_80_20pc_2(s,se,1)=(TP2)/(TP2+FN2);
% 
%     tic;
...
%  predizioni=predict(mod,y_y2);
%  time_predict3(s,se,2)=toc;
%  accuracy_80_20_2(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
...
%  time_predict3(s,se,3)=toc;
%  accuracy_80_20_2(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
...
%  predizioni=predict(mod,y_y2);
%  time_predict3(s,se,1)=toc;
%  accuracy_80_20_3(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
...
%  predizioni=predict(mod,y_y2);
%  time_predict3(s,se,2)=toc;
%  accuracy_80_20_3(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
...
%  predizioni=predict(mod,y_y);
%  time_predict3(s,se,3)=toc;
%  accuracy_80_20_3(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
