...
%  time_train1_4(s,se,1)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict1_4(s,se,1)=toc;
%  accuracy_20_80_1_4(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
...
%     precision1_20_80pc_1_4(s,se,1)=(TP)/(TP+FP);
%     recall1_20_80pc_1_4(s,se,1)=(TP)/(TP+FN);
%    positive_class = 2;
...
%     precision2_20_80pc_1_4(s,se,1)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_1_4(s,se,1)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcnet(x_x2,labels_tr,'OptimizeHyperparameters','auto');
%  time_train1_4(s,se,2)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict1_4(s,se,2)=toc;
%  accuracy_20_80_1_4(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_1_4(s,se,2)=(TP)/(TP+FP);
%     recall1_20_80pc_1_4(s,se,2)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_1_4(s,se,2)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_1_4(s,se,2)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcensemble(x_x,labels_tr,'OptimizeHyperparameters','auto');
%  time_train1_4(s,se,3)=toc;
%  tic;
%  predizioni=predict(mod,y_y);
%  time_predict1_4(s,se,3)=toc;
%  accuracy_20_80_1_4(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_1_4(s,se,3)=(TP)/(TP+FP);
%     recall1_20_80pc_1_4(s,se,3)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_1_4(s,se,3)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_1_4(s,se,3)=(TP2)/(TP2+FN2);
%     end
% end
% 
% 
...
%  tic;
%  mod=fitcsvm(x_x2,labels_tr,'KernelFunction','polynomial','OptimizeHyperparameters','auto');
%  time_train2_4(s,se,1)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict2_4(s,se,1)=toc;
%  accuracy_20_80_2_4(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_2_4(s,se,1)=(TP)/(TP+FP);
%     recall1_20_80pc_2_4(s,se,1)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_2_4(s,se,1)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_2_4(s,se,1)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcnet(x_x2,labels_tr,'OptimizeHyperparameters','auto');
%  time_train2_4(s,se,2)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict2_4(s,se,2)=toc;
%  accuracy_20_80_2_4(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_2_4(s,se,2)=(TP)/(TP+FP);
%     recall1_20_80pc_2_4(s,se,2)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_2_4(s,se,2)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_2_4(s,se,2)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcensemble(x_x,labels_tr,'OptimizeHyperparameters','auto');
%  time_train2_4(s,se,3)=toc;
%  tic;
%  predizioni=predict(mod,y_y);
%  time_predict2_4(s,se,3)=toc;
%  accuracy_20_80_2_4(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_2_4(s,se,3)=(TP)/(TP+FP);
%     recall1_20_80pc_2_4(s,se,3)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_2_4(s,se,3)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_2_4(s,se,3)=(TP2)/(TP2+FN2);
%     end
% end
% 
% for s=1:25
...
%  tic;
%  mod=fitcsvm(x_x2,labels_tr,'KernelFunction','polynomial','OptimizeHyperparameters','auto');
%  time_train3_4(s,se,1)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict3_4(s,se,1)=toc;
%  accuracy_20_80_3_4(s,se,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_3_4(s,se,1)=(TP)/(TP+FP);
%     recall1_20_80pc_3_4(s,se,1)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_3_4(s,se,1)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_3_4(s,se,1)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcnet(x_x2,labels_tr,'OptimizeHyperparameters','auto');
%  time_train3_4(s,se,2)=toc;
%  tic;
%  predizioni=predict(mod,y_y2);
%  time_predict3_4(s,se,2)=toc;
%  accuracy_20_80_3_4(s,se,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_3_4(s,se,2)=(TP)/(TP+FP);
%     recall1_20_80pc_3_4(s,se,2)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_3_4(s,se,2)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_3_4(s,se,2)=(TP2)/(TP2+FN2);
% 
%     tic;
%  mod=fitcensemble(x_x,labels_tr,'OptimizeHyperparameters','auto');
%  time_train3_4(s,se,3)=toc;
%  tic;
%  predizioni=predict(mod,y_y);
%  time_predict3_4(s,se,3)=toc;
%  accuracy_20_80_3_4(s,se,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
%  positive_class = 1;
% TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision1_20_80pc_3_4(s,se,3)=(TP)/(TP+FP);
%     recall1_20_80pc_3_4(s,se,3)=(TP)/(TP+FN);
%    positive_class = 2;
% TP2=sum((predizioni==positive_class) & (labels_ts==positive_class));
% FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
% FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
%     precision2_20_80pc_3_4(s,se,3)=(TP2)/(TP2+FP2);
%     recall2_20_80pc_3_4(s,se,3)=(TP2)/(TP2+FN2);
%     end
% end
for s=1:25
    for se=1:5
