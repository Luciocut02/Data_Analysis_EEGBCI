...
for s = 1:25
    for se = 1:5
        ...
        [feature_sogg_40pc,feature_sogg_60pc,time_extraction_feature3]=feature_freq_time_domain3_1(data, labels);
        ...
        featureStruct3_1.(matrix_name)=feature_sogg_40pc;
        featureStruct3_1.(matrix_name2)=feature_sogg_60pc;
        featureStruct3_1.(matrix_name3)=time_extraction_feature3;

    end
end
save('feature3_1.mat', '-struct', 'featureStruct3_1');
load('feature3_1.mat')
...
time_matrix_train_40_60_1_1(sub,ses,1)=toc;
  
tic;
predizioni=predict(modello,y_y2);
time_matrix_predict_40_60_1_1(sub,ses,1)=toc;
accuracy_40_60_1_1(sub,ses,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
positive_class = 1;
...
FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision1_40_60pc_1_1(sub,ses,1)=(TP)/(TP+FP);
    recall1_40_60pc_1_1(sub,ses,1)=(TP)/(TP+FN);
...
FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision2_40_60pc_1_1(sub,ses,1)=(TP2)/(TP2+FP2);
    recall2_40_60pc_1_1(sub,ses,1)=(TP2)/(TP2+FN2);
...
time_matrix_train_40_60_1_1(sub,ses,2)=toc;
tic;
predizioni=predict(modello,y_y2);
time_matrix_predict_40_60_1_1(sub,ses,2)=toc;
  
accuracy_40_60_1_1(sub,ses,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
positive_class = 1;

TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision1_40_60pc_1_1(sub,ses,2)=(TP)/(TP+FP);
    recall1_40_60pc_1_1(sub,ses,2)=(TP)/(TP+FN);
...
FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision2_40_60pc_1_1(sub,ses,2)=(TP2)/(TP2+FP2);
    recall2_40_60pc_1_1(sub,ses,2)=(TP2)/(TP2+FN2);
...
time_matrix_train_40_60_1_1(sub,ses,3)=toc;
tic;
predizioni=predict(modello,y_y);
time_matrix_predict_40_60_1_1(sub,ses,3)=toc;
accuracy_40_60_1_1(sub,ses,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
positive_class = 1;

TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision1_40_60pc_1_1(sub,ses,3)=(TP)/(TP+FP);
    recall1_40_60pc_1_1(sub,ses,3)=(TP)/(TP+FN);
...
FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision2_40_60pc_1_1(sub,ses,3)=(TP2)/(TP2+FP2);
    recall2_40_60pc_1_1(sub,ses,3)=(TP2)/(TP2+FN2);
