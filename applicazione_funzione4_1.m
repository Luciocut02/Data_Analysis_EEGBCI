...
for s = 1:25
    for se = 1:5
        ...
        [feature_sogg_20pc,feature_sogg_80pc,time_extraction_featur4]=feature_freq_time_domain4_1(data, labels);
        ...
        featureStruct4_1.(matrix_name)=feature_sogg_20pc;
        featureStruct4_1.(matrix_name2)=feature_sogg_80pc;
        featureStruct4_1.(matrix_name3)=time_extraction_featur4;

    end
end
save('feature4_1.mat', '-struct', 'featureStruct4_1');
load('feature4_1.mat')
...
time_matrix_train_20_80_1_1(sub,ses,1)=toc;
  
tic;
predizioni=predict(modello,y_y2);
time_matrix_predict_20_80_1_1(sub,ses,1)=toc;
accuracy_20_80_1_1(sub,ses,1)=sum(predizioni==labels_ts)/length(labels_ts)*100;
positive_class = 1;
...
FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision1_20_80pc_1_1(sub,ses,1)=(TP)/(TP+FP);
    recall1_20_80pc_1_1(sub,ses,1)=(TP)/(TP+FN);
...
FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision2_20_80pc_1_1(sub,ses,1)=(TP2)/(TP2+FP2);
    recall2_20_80pc_1_1(sub,ses,1)=(TP2)/(TP2+FN2);
...
time_matrix_train_20_80_1_1(sub,ses,2)=toc;
tic;
predizioni=predict(modello,y_y2);
time_matrix_predict_20_80_1_1(sub,ses,2)=toc;
  
accuracy_20_80_1_1(sub,ses,2)=sum(predizioni==labels_ts)/length(labels_ts)*100;
positive_class = 1;

TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision1_20_80pc_1_1(sub,ses,2)=(TP)/(TP+FP);
    recall1_20_80pc_1_1(sub,ses,2)=(TP)/(TP+FN);
...
FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision2_20_80pc_1_1(sub,ses,2)=(TP2)/(TP2+FP2);
    recall2_20_80pc_1_1(sub,ses,2)=(TP2)/(TP2+FN2);
...
time_matrix_train_20_80_1_1(sub,ses,3)=toc;
tic;
predizioni=predict(modello,y_y);
time_matrix_predict_20_80_1_1(sub,ses,3)=toc;
accuracy_20_80_1_1(sub,ses,3)=sum(predizioni==labels_ts)/length(labels_ts)*100;
positive_class = 1;

TP=sum((predizioni==positive_class) & (labels_ts==positive_class));
FP=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision1_20_80pc_1_1(sub,ses,3)=(TP)/(TP+FP);
    recall1_20_80pc_1_1(sub,ses,3)=(TP)/(TP+FN);
...
FP2=sum((predizioni==positive_class) & (labels_ts~=positive_class));
FN2=sum((predizioni~=positive_class) & (labels_ts==positive_class));
    precision2_20_80pc_1_1(sub,ses,3)=(TP2)/(TP2+FP2);
    recall2_20_80pc_1_1(sub,ses,3)=(TP2)/(TP2+FN2);
    end
end