...
for sub=1:25
    ...
    if accuracy_60_40_csr_1(sub,:)>60
        accuracy_60_40_csr_def(sub,:)=accuracy_60_40_csr_1(sub,:);
    end
...
accuracy_60_40_csr_def2=zeros(size(val2,1),3);
for sub=1:size(val2,2)
       accuracy_60_40_csr_def2(sub,1:3)=accuracy_60_40_csr_def(val2(1,sub),1:3);
end
...
for sub=1:size(accuracy_60_40_csr_def2,1)
    for cl=1:3
    time_train_60_40_csr_def(sub,1,cl)=time_train_60_40_csr_1(val2(1,sub),1,cl);
    time_predict_60_40_csr_def(sub,1,cl)=time_predict_60_40_csr_1(val2(1,sub),1,cl);
    end
end
...
for sub=1:size(accuracy_60_40_csr_def2,1)
    for cl=1:3
       precision1_60_40_csr_def(sub,1,cl)=precision1_60_40_csr_1(val2(1,sub),1,cl);
       precision2_60_40_csr_def(sub,1,cl)=precision2_60_40_csr_1(val2(1,sub),1,cl);
       recall1_60_40_csr_def(sub,1,cl)=recall1_60_40_csr_1(val2(1,sub),1,cl);
       recall2_60_40_csr_def(sub,1,cl)=recall2_60_40_csr_1(val2(1,sub),1,cl);
    end
end
%plot
for d=1:3
