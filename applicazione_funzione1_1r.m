...
for s=1:25
    for se=1:5
        ...
        [feature_sogg_80pc,feature_sogg_20pc,time_extraction_feature1_1]=feature_freq_time_domain1_1(p_p, labels);
        [feature_sogg_80pc2,feature_sogg_20pc2,time_extraction_feature1_2]=feature_freq_time_domain1_1(t_t, labels);
        [feature_sogg_80pc3,feature_sogg_20pc3,time_extraction_feature1_3]=feature_freq_time_domain1_1(v_v, labels);
