...
for s = 1:25
    for se =1:5
        ...
        [feature_sogg_60pc,feature_sogg_40pc,time_extraction_feature2_1]=feature_freq_time_domain2_1(p_p, labels);
        [feature_sogg_60pc2,feature_sogg_40pc2,time_extraction_feature2_2]=feature_freq_time_domain2_1(t_t, labels);
        [feature_sogg_60pc3,feature_sogg_40pc3,time_extraction_feature2_3]=feature_freq_time_domain2_1(v_v, labels);
