...
for sub=1:25
    for cl=1:3
    if accuracy_60_40_csr_3(sub,1,cl)>60
        accuracy_60_40_csr3_def(sub,cl)=accuracy_60_40_csr_3(sub,cl);
    end
    end
end

val1=find((accuracy_60_40_csr3_def(1:end)~=0));
accuracy_60_40_csr3_def2=zeros(size(val1,1),3);
for sub=1:size(val1,2)
       accuracy_60_40_csr3_def2(sub,1:3)=accuracy_60_40_csr3_def(val1(1,sub),1:3);
end
...
for sub=1:size(accuracy_60_40_csr3_def2,1)
    for cl=1:3
    time_train_60_40_csr3_def3(sub,1,cl)=time_train_60_40_csr_3(val1(1,sub),1,cl);
    time_predict_60_40_csr3_def3(sub,1,cl)=time_predict_60_40_csr_3(val1(1,sub),1,cl);
    end
end
...
for sub=1:size(accuracy_60_40_csr3_def2,1)
    for cl=1:3
       precision1_60_40_csr3_def3(sub,1,cl)=precision1_60_40_csr_3(val1(1,sub),1,cl);
       precision2_60_40_csr3_def3(sub,1,cl)=precision2_60_40_csr_3(val1(1,sub),1,cl);
       recall1_60_40_csr3_def3(sub,1,cl)=recall1_60_40_csr_3(val1(1,sub),1,cl);
       recall2_60_40_csr3_def3(sub,1,cl)=recall2_60_40_csr_3(val1(1,sub),1,cl);
    end
end
%plot
for d=1:3
...
mean_class_60_40c3s=mean(accuracy_60_40_csr3_def2,1);

time_train_80_20_subcs=mean(time_train_80_20_csr3_def3,3);
time_train_80_20_classcs=mean(time_train_80_20_csr3_def3,1);
time_predict_80_20_subcs=mean(time_predict_80_20_csr3_def3,2);
time_predict_80_20_classcs=mean(time_predict_80_20_subcs,1);
time_train_60_40_subcs=mean(time_train_60_40_csr3_def3,3);
time_train_60_40_classcs=mean(time_train_60_40_csr3_def3,1);
time_predict_60_40_subcs=mean(time_predict_60_40_csr3_def3,2);
