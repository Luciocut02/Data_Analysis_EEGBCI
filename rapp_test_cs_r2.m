for sub=1:25
        if accuracy_80_20cs2(sub,:)>65
           accuracy_80_20_csr2_def(sub,:)=accuracy_80_20cs2(sub,:);
        end
end
...
for sub=1:size(val1,2)
    accuracy_80_20_csr2_def2(sub,:)=accuracy_80_20_csr2_def(val1(1,sub),:);
end
for sub=1:25
        if accuracy_60_40cs2(sub,:)>60
           accuracy_60_40_csr2_def(sub,:)=accuracy_60_40cs2(sub,:);
        end
end
%choose the min threesold to select the subjects.

val2=find(accuracy_60_40_csr2_def(1:23)~=0);
for sub=1:size(val2,2)
    accuracy_60_40_csr2_def2(sub,:)=accuracy_60_40_csr2_def(val2(1,sub),:);
end
for sub=1:length(accuracy_80_20_csr2_def2)
    for cl=1:3
    time_train_80_20_csr2_def(sub,cl)=time_train1(val1(1,sub),cl);
    end
end

for sub=1:length(accuracy_60_40_csr2_def2)
    for cl=1:3
    time_train_60_40_csr2_def(sub,cl)=time_train2(val2(1,sub),cl);
    end
end

for sub=1:length(accuracy_80_20_csr2_def2)
    for cl=1:3
    precision1_80_20_csr2_def(sub,cl)=precision1_80_20cs_2(val1(1,sub),cl);
    precision2_80_20_csr2_def(sub,cl)=precision2_80_20cs_2(val1(1,sub),cl);
    recall1_80_20_csr2_def(sub,cl)=recall1_80_20cs_2(val1(1,sub),cl);
    recall2_80_20_csr2_def(sub,cl)=recall2_80_20cs_2(val1(1,sub),cl);
    end
end
for sub=1:length(accuracy_60_40_csr2_def2)
    for cl=1:3
       precision1_60_40_csr2_def(sub,cl)=precision1_60_40cs_2(val2(1,sub),cl);
       precision2_60_40_csr2_def(sub,cl)=precision2_60_40cs_2(val2(1,sub),cl);
       recall1_60_40_csr2_def(sub,cl)=recall1_60_40cs_2(val2(1,sub),cl);
       recall2_60_40_csr2_def(sub,cl)=recall2_60_40cs_2(val2(1,sub),cl);
    end
end
%plot
for d=1:3
...
time_train_80_20_classcs2=mean(time_train_80_20_csr2_def,1);
...
time_train_60_40_classcs2=mean(time_train_60_40_csr2_def,1);
