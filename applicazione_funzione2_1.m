...
for s = 1:25
    for se = 1:5
        ...
        [feature_sogg_60pc,feature_sogg_40pc,time_extraction_feature2]=feature_freq_time_domain2_1(data, labels);
        ...
        featureStruct2_1.(matrix_name3)=time_extraction_feature2;

    end
end
save('feature2_1.mat', '-struct', 'featureStruct2_1');
load('feature2_1.mat')
...
n_test=n_trial-n_train;
labels_tr=labels2(1,1:n_train);
labels_ts=labels2(1,n_train+1:n_trial);
labels_tr=transpose(labels_tr);
labels_ts=transpose(labels_ts);
x_x=normalize(x_x,'zscore');
y_y=normalize(y_y,'zscore');
