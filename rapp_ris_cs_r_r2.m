for sub=1:25
    for cl=1:3
    [val,idx]=sort(accuracy_80_20_csr_2(sub,1,cl),1,'descend');
    accuracy_80_20_csr2_def(sub,1,cl)=val;
    accuracy_80_20_csr2_def(sub,2,cl)=idx;
    [val2,idx2]=sort(accuracy_60_40_csr_2(sub,1,cl),1,'descend');
...
for sub=1:length(accuracy_80_20_csr2_def2)
    for cl=1:3
    time_train_80_20_csr2_def(sub,1,cl)=time_train_80_20_csr_2(accuracy_80_20_csr2_def2(sub,2,cl),1,cl);
    time_predict_80_20_csr2_def(sub,1,cl)=time_predict_80_20_csr_2(accuracy_80_20_csr2_def2(sub,2,cl),1,cl);
    end
end

for sub=1:length(accuracy_60_40_csr2_def2)
    for cl=1:3
    time_train_60_40_csr2_def(sub,1,cl)=time_train_60_40_csr_2(accuracy_60_40_csr2_def2(sub,2,cl),1,cl);
    time_predict_60_40_csr2_def(sub,1,cl)=time_predict_60_40_csr_2(accuracy_60_40_csr2_def2(sub,2,cl),1,cl);
    end
end

for sub=1:length(accuracy_80_20_csr2_def2)
    for cl=1:3
    precision1_80_20_csr2_def=precision1_80_20_csr_2(accuracy_80_20_csr2_def2(sub,2,cl),1,cl);
    precision2_80_20_csr2_def=precision2_80_20_csr_2(accuracy_80_20_csr2_def2(sub,2,cl),1,cl);
    recall1_80_20_csr2_def=recall1_80_20_csr_2(accuracy_80_20_csr2_def2(sub,2,cl),1,cl);
    recall2_80_20_csr2_def=recall2_80_20_csr_2(accuracy_80_20_csr2_def2(sub,2,cl),1,cl);
    end
end
for sub=1:length(accuracy_60_40_csr2_def2)
    for cl=1:3
       precision1_60_40_csr2_def=precision1_60_40_csr_2(accuracy_60_40_csr2_def2(sub,2,cl),1,cl);
       precision2_60_40_csr2_def=precision2_60_40_csr_2(accuracy_60_40_csr2_def2(sub,2,cl),1,cl);
       recall1_60_40_csr2_def=recall1_60_40_csr_2(accuracy_60_40_csr2_def2(sub,2,cl),1,cl);
       recall2_60_40_csr2_def=recall2_60_40_csr_2(accuracy_60_40_csr2_def2(sub,2,cl),1,cl);
    end
end
%plot
for d=1:3
