...
for su=1:25
    ...
    matrix_test_80_20csr(size(v_v,1)+1:size(v_v,1)+size(g_g,1),:)=g_g(:,:);
...
save('cs1rr1.mat','-struct','matrix_csr1_1')
save('cs1rr2.mat','-struct','matrix_csr2_1')
save('cs1rr3.mat','-struct','matrix_csr3_1')
load('cs1rr1.mat')
load('cs1rr2.mat')
load('cs1rr3.mat')
load('labels_80_20csr.mat')
for su=1:25
    name1=sprintf('matrix_train_80_20csr_%d_1',su);
    name2=sprintf('matrix_test_80_20csr_%d_1',su);
